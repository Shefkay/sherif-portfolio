            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video">
                ...
                <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  ...
                  <a className="p-3 rounded-full glass hover:bg-primary hover:text-primary-foreground transition-all">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag, tagidx) => (
                    <span className=" px-4 py-1.5 rounded-full bg-surface text-xs font-medium border border-border/50 text-muted-foreground hover:border-primary transition-all duration-300">
                      {tag}
                    </span>
                  ))}
                </div>
