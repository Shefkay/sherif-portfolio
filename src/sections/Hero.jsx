...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animate-delay-200">
                Hi, I'm Sherif Ayantoyinbo - a software engineer specializing in React, Js, Css, and Html. I build scalable, performant web applications that users love.
              </p>
            </div>
            {/* CTAs */}
          ...
          <div className="relative animate-fade-in animate-delay-300">
            ...
            <div className="relative max-w-md mx-auto">
              <div className="absolute inset-0 rounded-3xl bg-liner-to-br from-primary/30 via-transparent to-primary/10 blur-2xl animate-pulse" />
              <div className="relative glass rounded-3xl p-2 glow-border">
                <img src="/shefkay-profile-photo.png" alt="Sherif Ayantoyinbo" className="w-full aspect-4/5 object-cover rounded-2xl"
                />
        ...
        <div className="mt-20 animate-fade-in animate-delay-600">
          ...
          <div className="relative overflow-hidden">
            <div className="flex animate-marguee">
      ...
      <div className="absolute bottom-8 left-1/2 -translatex-1/2 animate-fade-in animated-delay-800">
        <a
          href="#about"
